...
-- Thu 08 Aug 2019 07:58:30 PM CDT
...
CREATE TABLE IF NOT EXISTS `mydb`.`homeworkResponse` (
  `homework_idHomework` INT NOT NULL,
  ...
  `date` DATETIME NOT NULL,
  PRIMARY KEY (`homework_idHomework`, `user_idUser`),
  INDEX `fk_homework_has_user_user2_idx` (`user_idUser` ASC)  ,
  INDEX `fk_homework_has_user_homework2_idx` (`homework_idHomework` ASC)  ,
